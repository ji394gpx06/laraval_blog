    ...
    <div>
       <h2 class="text-gray-700 font-bold text-5xl pb-4">
        ...
        <span class="text-gray-500">
            By <span class="font-bold italic text-gray-800">Code With Dary</span><span>
                , 1 day ago
        </span>
        <p class="text-xl text-gray-700 pt-8 pb-10 leading-8 font-light">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            Blanditiis qui magnam vel. Ipsum provident minima, nisu teneturvoluptate quia maxime, qubusdan blanditiis expedita rem,
            consequuntur mollitia? Voluptate est saepe tempora?
        </p>
